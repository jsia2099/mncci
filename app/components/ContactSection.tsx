    ...
    <section id="contact-section" className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 justify-center mb-4">
          ...
          <span className="text-sm text-gray-500 tracking-wider uppercase">Contact Us</span>
          <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href= "tel:+639702424653" className="text-gray-600">+63 970 242 4653</a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:metronagachamber86@gmail.com" className="text-gray-600 hover:text-blue-600 transition duration-300">metronagachamber86@gmail.com</a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <Link href="https://www.facebook.com/MetroNagaChamberofCommerceandIndustry/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600 transition duration-300">
            ...
            <div className="md:w-2/3 bg-gray-50 rounded-lg shadow-md overflow-hidden">
              ...
              <form action={handleSubmit} className="p-8 space-y-6">
                ...
                <div>
                  <Label htmlFor="phone" className="text-gray-700 font-semibold">Contact Number</Label>
                  <Input id="phone" name="phone" type="tel" placeholder="Your phone number" required className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="message" className="text-gray-700 font-semibold">Message</Label>
                  <Textarea id="message" name="message" placeholder="Your message" required className="mt-1 min-h-[100px]" />
                </div>
