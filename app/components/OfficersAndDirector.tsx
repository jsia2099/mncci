...
const officers = [
  ...
  { title: 'VP for Programs & Projects', name: 'ELEANOR ZUÑIGA-MONTEMAYOR', image: '/images/officers/placeholder.png' , level: 2},
  { title: 'Board Secretary', name: 'Emily Chen', image: '/images/officers/placeholder.png' , level: 2},
  { title: 'Treasurer', name: 'LAURIANO L. BIHAG JR.', image: '/images/officers/placeholder.png', level: 2 },
